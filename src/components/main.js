   ...
   <React.Fragment>
      ...
      <form onSubmit={getWeatherInfo}>
           <div className="control">
            ...
            <input type="text" name="name" placeholder="City or ZipCode to check weather" onChange={e => setCity(e.target.value)} />
            <input type="text" name="name" placeholder="Choose up to 14 days of forecast from today" onChange={e => setDays(e.target.value)} />
           </div>
